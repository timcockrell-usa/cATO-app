...
const { mapActivities, showActivitiesSummary, validateActivity } = require('./lib/mapActivities');
const { mapCapabilities, showCapabilitiesSummary, validateCapability } = require('./lib/mapCapabilities');
const { log, createBackupFilename } = require('./lib/utils');
