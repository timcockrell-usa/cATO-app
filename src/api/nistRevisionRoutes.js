...
exports.nistRevisionService = void 0;
// Placeholder implementation - replace with Azure Functions calls in production
exports.nistRevisionService = {
    getMappings: function (fromRevision, toRevision) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    performGapAnalysis: function (tenantId, fromRevision, toRevision) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.warn('Gap analysis not available - implement in Azure Functions');
            throw new Error('Server-side functionality moved to Azure Functions - see deployment guide');
        });
    }); },
    upgradeRevision: function (tenantId, fromRevision, toRevision) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
exports.default = exports.nistRevisionService;
