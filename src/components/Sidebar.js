...
// Get environment classification based on deployment environment
const getEnvironmentClassification = () => {
    ...
    return classifications[env] || 'IL2';
};

export function Sidebar() {
    const location = useLocation();
    const classification = getEnvironmentClassification();
    ...
    return (_jsx("div", { className: "w-64 bg-card border-r border-border shadow-card", children: _jsxs("div", { className: "flex flex-col h-screen", children: [_jsx("div", { className: "p-6 border-b border-border", children: _jsx("h2", { className: "text-sm font-semibold text-muted-foreground uppercase tracking-wider", children: "Navigation" }) }), _jsx("nav", { className: "flex-1 px-4 py-6 space-y-2", children: navigation.map((item) => {
                    ...
                    }) }), _jsx("div", { className: "p-4 border-t border-border", children: _jsxs("div", { className: "text-xs text-muted-foreground", children: [_jsxs("p", { children: ["Last Updated: ", new Date().toLocaleTimeString()] }), _jsxs("p", { className: "mt-1", children: ["Classification: ", classification] })] }) })] }) }));
}
