/* Enhanced ZTA activities data based on comprehensive CSV with Azure implementations */
import type { ZTAActivity } from '../services/cosmosService';

export const ztaActivitiesFromCSV: ZTAActivity[] = [
...
export const ztaPillars = [
  {
    ...
    maturity: Math.round(
      ztaActivitiesFromCSV
        .filter(a => a.pillar === 'User')
        .reduce((sum, a) => sum + a.maturity, 0) /
      ztaActivitiesFromCSV.filter(a => a.pillar === 'User').length
    ),
    activities: ztaActivitiesFromCSV.filter(a => a.pillar === 'User'),
  },
  {
    id: 'device',
    name: 'Device',
    ...
    maturity: Math.round(
      ztaActivitiesFromCSV
        .filter(a => a.pillar === 'Device')
        .reduce((sum, a) => sum + a.maturity, 0) /
      ztaActivitiesFromCSV.filter(a => a.pillar === 'Device').length
    ),
    activities: ztaActivitiesFromCSV.filter(a => a.pillar === 'Device'),
  },
  {
    id: 'applications',
    ...
    maturity: Math.round(
      ztaActivitiesFromCSV
        .filter(a => a.pillar === 'Applications and Workloads')
        .reduce((sum, a) => sum + a.maturity, 0) /
      ztaActivitiesFromCSV.filter(a => a.pillar === 'Applications and Workloads').length
    ),
    activities: ztaActivitiesFromCSV.filter(a => a.pillar === 'Applications and Workloads'),
  },
  {
    id: 'data',
    name: 'Data',
    ...
    maturity: Math.round(
      ztaActivitiesFromCSV
        .filter(a => a.pillar === 'Data')
        .reduce((sum, a) => sum + a.maturity, 0) /
      ztaActivitiesFromCSV.filter(a => a.pillar === 'Data').length
    ),
    activities: ztaActivitiesFromCSV.filter(a => a.pillar === 'Data'),
  },
  {
    id: 'network',
    ...
    maturity: Math.round(
      ztaActivitiesFromCSV
        .filter(a => a.pillar === 'Network and Environment')
        .reduce((sum, a) => sum + a.maturity, 0) /
      ztaActivitiesFromCSV.filter(a => a.pillar === 'Network and Environment').length
    ),
    activities: ztaActivitiesFromCSV.filter(a => a.pillar === 'Network and Environment'),
  },
  {
    id: 'automation',
    ...
    maturity: Math.round(
      ztaActivitiesFromCSV
        .filter(a => a.pillar === 'Automation and Orchestration')
        .reduce((sum, a) => sum + a.maturity, 0) /
      ztaActivitiesFromCSV.filter(a => a.pillar === 'Automation and Orchestration').length
    ),
    activities: ztaActivitiesFromCSV.filter(a => a.pillar === 'Automation and Orchestration'),
  },
  {
    id: 'visibility',
    ...
    maturity: Math.round(
      ztaActivitiesFromCSV
        .filter(a => a.pillar === 'Visibility and Analytics')
        .reduce((sum, a) => sum + a.maturity, 0) /
      ztaActivitiesFromCSV.filter(a => a.pillar === 'Visibility and Analytics').length
    ),
    activities: ztaActivitiesFromCSV.filter(a => a.pillar === 'Visibility and Analytics'),
  },
];

// Calculate overall ZTA maturity
export const overallZTAMaturity = Math.round(
  ztaActivitiesFromCSV.reduce((sum, a) => sum + a.maturity, 0) / ztaActivitiesFromCSV.length
);
