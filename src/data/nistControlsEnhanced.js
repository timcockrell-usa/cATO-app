...
exports.overallMetrics = exports.controlFamilies = exports.nistControlsFromCSV = void 0;
exports.nistControlsFromCSV = [
    {
        id: 'AC-1',
...
exports.controlFamilies = [
    {
        id: 'AC',
        name: 'Access Control',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Access Control'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Access Control' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Access Control' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Access Control' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Access Control'; }),
    },
    {
        id: 'AT',
        name: 'Awareness and Training',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Awareness and Training'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Awareness and Training' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Awareness and Training' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Awareness and Training' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Awareness and Training'; }),
    },
    {
        id: 'AU',
        name: 'Audit and Accountability',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Audit and Accountability'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Audit and Accountability' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Audit and Accountability' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Audit and Accountability' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Audit and Accountability'; }),
    },
    {
        id: 'CA',
        name: 'Assessment, Authorization, and Monitoring',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Assessment, Authorization, and Monitoring'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Assessment, Authorization, and Monitoring' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Assessment, Authorization, and Monitoring' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Assessment, Authorization, and Monitoring' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Assessment, Authorization, and Monitoring'; }),
    },
    {
        id: 'CM',
        name: 'Configuration Management',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Configuration Management'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Configuration Management' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Configuration Management' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Configuration Management' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Configuration Management'; }),
    },
    {
        id: 'CP',
        name: 'Contingency Planning',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Contingency Planning'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Contingency Planning' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Contingency Planning' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Contingency Planning' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Contingency Planning'; }),
    },
    {
        id: 'IA',
        name: 'Identification and Authentication',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Identification and Authentication'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Identification and Authentication' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Identification and Authentication' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Identification and Authentication' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Identification and Authentication'; }),
    },
    {
        id: 'IR',
        name: 'Incident Response',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Incident Response'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Incident Response' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Incident Response' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Incident Response' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Incident Response'; }),
    },
    {
        id: 'MA',
        name: 'Maintenance',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Maintenance'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Maintenance' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Maintenance' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Maintenance' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Maintenance'; }),
    },
    {
        id: 'MP',
        name: 'Media Protection',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Media Protection'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Media Protection' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Media Protection' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Media Protection' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Media Protection'; }),
    },
    {
        id: 'PE',
        name: 'Physical and Environmental Protection',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Physical and Environmental Protection'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Physical and Environmental Protection' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Physical and Environmental Protection' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Physical and Environmental Protection' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Physical and Environmental Protection'; }),
    },
    {
        id: 'PL',
        name: 'Planning',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Planning'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Planning' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Planning' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Planning' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Planning'; }),
    },
    {
        id: 'PM',
        name: 'Program Management',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Program Management'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Program Management' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Program Management' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Program Management' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Program Management'; }),
    },
    {
        id: 'PS',
        name: 'Personnel Security',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Personnel Security'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Personnel Security' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Personnel Security' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Personnel Security' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Personnel Security'; }),
    },
    {
        id: 'RA',
        name: 'Risk Assessment',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Risk Assessment'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Risk Assessment' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Risk Assessment' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Risk Assessment' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'Risk Assessment'; }),
    },
    {
        id: 'SA',
        name: 'System and Services Acquisition',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Services Acquisition'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Services Acquisition' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Services Acquisition' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Services Acquisition' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Services Acquisition'; }),
    },
    {
        id: 'SC',
        name: 'System and Communications Protection',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Communications Protection'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Communications Protection' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Communications Protection' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Communications Protection' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Communications Protection'; }),
    },
    {
        id: 'SI',
        name: 'System and Information Integrity',
        total: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Information Integrity'; }).length,
        compliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Information Integrity' && c.status === 'compliant'; }).length,
        partial: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Information Integrity' && c.status === 'partial'; }).length,
        noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Information Integrity' && c.status === 'noncompliant'; }).length,
        controls: exports.nistControlsFromCSV.filter(function (c) { return c.controlFamily === 'System and Information Integrity'; }),
    },
];
// Calculate overall compliance metrics
exports.overallMetrics = {
    total: exports.nistControlsFromCSV.length,
    compliant: exports.nistControlsFromCSV.filter(function (c) { return c.status === 'compliant'; }).length,
    partial: exports.nistControlsFromCSV.filter(function (c) { return c.status === 'partial'; }).length,
    noncompliant: exports.nistControlsFromCSV.filter(function (c) { return c.status === 'noncompliant'; }).length,
    compliancePercentage: Math.round((exports.nistControlsFromCSV.filter(function (c) { return c.status === 'compliant'; }).length / exports.nistControlsFromCSV.length) * 100),
};
